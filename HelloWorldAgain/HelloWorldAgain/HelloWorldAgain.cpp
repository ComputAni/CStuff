// HelloWorldAgain.cpp : Defines the entry point for the console application
//
...
int main() {
	...
	typedef struct hello_header hello_t;
	struct hello_header {
		int max;
		int min;
	};
...
// #comments are for python and perl
// comments are for c/c++
...
/*
"""
Denotes multi line comments for python
"""
*/
